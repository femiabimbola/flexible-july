// Typescript function is used here
    ...
    <footer className='flexStart footer'>
      <div className='flex flex-col gap-12 w-full'>
         <div className='flex items-start flex-col'>
          <Image  alt='flexibble' src={'/logo-purple.svg'} width={115} height={38} />
      ...
      <div className='flexBetween footer_copyright'>
        <p> @ 2023 Flexible. Application made by Femi Abimbola </p>
        <p className='text-gray'> 
          <span className='font-semibold text-black'> 10,200</span> Project Submitted
        </p>
      </div>
    </footer>
